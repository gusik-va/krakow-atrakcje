...
function Galeria(id, zdjecia, css, ochrona, zaladuj)
{
	...
	this.pokaz = function(i)
	{
		...
		Galeria.okno = window.open('', this.id, 'menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=yes,resizable=yes,width=400,height=400,backgroundColor=red');
